...
import br.com.dio.ui.custom.button.ResetButon;
...
public class MainScreen {
    ...
    private JButton finisgGameButton;
    ...
    private void addFinishButton(JPanel mainPanel) {
         finisgGameButton = new FinishGameButton(e -> {
         if(boardService.gameIsFinished()){
             JOptionPane.showConfirmDialog(null, "Parábens você concluiu o jogo");
             resetButton.setEnabled(false);
             checkGameStatusButton.setEnabled(false);
             finisgGameButton.setEnabled(false);
         } else{
        ...
        mainPanel.add(finisgGameButton);
    }
    ...
    private void addResetButton(JPanel mainPanel) {
         resetButton = new ResetButon(e ->{
            var dialoResult = JOptionPane.showConfirmDialog(
                    null,
