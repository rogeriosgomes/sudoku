...
public class Main {
    ...
    private static void startGame(Map<String, String> positions) {
        if(nonNull(board)){
            System.out.println("O jogo já foi incluido");
            return;
        }
        ...
        System.out.println("O jogo está pronto para comerçar");
    }
    ...
    private static void inputNumber() {
        ...
        var linh = runUntilGetValidNumber(0,8);

        System.out.printf("Infome o número que vai entrar na posição [%s,%s]\n", col, linh);
        var value = runUntilGetValidNumber(1,9);

        if(!board.changeValue(col, linh, value)){
    ...
    private static void clearGame() {
        ...
        System.out.println("Ter certeza que deseja limpar seu joogo e perder todo seu progresso?");
    ...
    private static void finishGame() {
        ...
        if(board.gameIsFinished()){
            ...
            System.out.println("Você ainda precisa preencher");
        }
